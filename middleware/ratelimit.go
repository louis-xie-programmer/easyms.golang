...
type LimiterManager struct {
	ipRules        []config.IPLimitRule
	uaRules        []config.UALimitRule
...
type ConsulRateLimitConfig struct {
	IPLimits []config.IPLimitRule `yaml:"ip_limits" json:"ip_limits"`
	UALimits []config.UALimitRule `yaml:"ua_limits" json:"ua_limits"`
}
